...
join(res.keyCommands,{
	...
	-- B. HOTAS Throttle
	{combos = {{key = 'C'}},							down = iCommandPlaneModeCannon,																name = _('CNM AA Gun'),										category = _('HOTAS')},
	...
	-- PCA: Weapons Management
	{													down = 3249, up = 3249, cockpit_device_id = devices.PCA_PPA, value_down = 1,				name = _('Selective Jettison ON'),							category = _('Weapons Management')},
	{													down = 3249, up = 3249, cockpit_device_id = devices.PCA_PPA, value_down = 0,				name = _('Selective Jettison OFF'),							category = _('Weapons Management')},
	{													down = 3248, up = 3248, cockpit_device_id = devices.PCA_PPA, value_down = 1,				name = _('Selective Jettison Safety Cover OPEN'),			category = _('Weapons Management')},
	{													down = 3248, up = 3248, cockpit_device_id = devices.PCA_PPA, value_down = 0,				name = _('Selective Jettison Safety Cover CLOSED'),			category = _('Weapons Management')},
	{combos = {{key = 'E', reformers = {'LShift'}}},	down = 3409, up = 3409, cockpit_device_id = devices.PCA_PPA, value_up = 0, value_down = 1,	name = _('Emergency Jettison'),								category = _('Weapons Management')},
	{													down = 3206, up = 3206, cockpit_device_id = devices.VTH_VTB, value_down = 0,				name = _('Auxiliary Gunsight OFF'),							category = _('Weapons Management')},
	{													down = 3206, up = 3206, cockpit_device_id = devices.VTH_VTB, value_down = 1,				name = _('Auxiliary Gunsight ON'),							category = _('Weapons Management')},
    ...
    --PPA
    {													down = 3275, up = 3275, cockpit_device_id = devices.PCA_PPA, value_down = -1, value_up = 0,	name = _('PPA Test Switch - Test'),							category = _('Weapons Management')},
    {													down = 3275, up = 3275, cockpit_device_id = devices.PCA_PPA, value_down =  1, value_up = 0,	name = _('PPA Test Switch - Weapon Loadout'),				category = _('Weapons Management')},
	
	-- PPA: Weapons Preparation
	{													down = 3265, up = 3265, cockpit_device_id = devices.PCA_PPA, value_down =  1,				name = _('Missile Selector: Fire Left 530D First'),				category = _('Weapons Preparation')},
	{													down = 3265, up = 3265, cockpit_device_id = devices.PCA_PPA, value_down =  0,				name = _('Missile Selector: Automatic 530D Fire Selection'),	category = _('Weapons Preparation')},
	{													down = 3265, up = 3265, cockpit_device_id = devices.PCA_PPA, value_down = -1,				name = _('Missile Selector: Fire Right 530D First'),			category = _('Weapons Preparation')},
	{													down = 3266, up = 3266, cockpit_device_id = devices.PCA_PPA, value_down =  0,				name = _('MIS PREP: Super 530D Standby Toggle'),				category = _('Weapons Preparation')},
	{													down = 3272, up = 3272, cockpit_device_id = devices.PCA_PPA, value_down =  0,				name = _('MAG PREP: MAGIC II Standby Toggle'),					category = _('Weapons Preparation')},
	{													down = 3276, up = 3276, cockpit_device_id = devices.PCA_PPA, value_down =  1,				name = _('Bomb Fuze: INERT'),									category = _('Weapons Preparation')},
	{													down = 3276, up = 3276, cockpit_device_id = devices.PCA_PPA, value_down =  0.5,				name = _('Bomb Fuze: RET'),										category = _('Weapons Preparation')},
	{													down = 3276, up = 3276, cockpit_device_id = devices.PCA_PPA, value_down =  0,				name = _('Bomb Fuze: INST'),									category = _('Weapons Preparation')},
	{													down = 3277, up = 3277, cockpit_device_id = devices.PCA_PPA, value_down =  1, value_up = 0,	name = _('Bomb Qty Increase'),									category = _('Weapons Preparation')},
	{													down = 3277, up = 3277, cockpit_device_id = devices.PCA_PPA, value_down = -1, value_up = 0,	name = _('Bomb Qty Decrease'),									category = _('Weapons Preparation')},
	{													down = 3278, up = 3278, cockpit_device_id = devices.PCA_PPA, value_down = -1, value_up = 0,	name = _('Bomb Release Interval Increase'),						category = _('Weapons Preparation')},
	{													down = 3278, up = 3278, cockpit_device_id = devices.PCA_PPA, value_down =  1, value_up = 0,	name = _('Bomb Release Interval Decrease'),						category = _('Weapons Preparation')},
	{													down = 3279, up = 3279, cockpit_device_id = devices.PCA_PPA, value_down =  0,				name = _('530D/Rockets/Guns TOT/PAR Firing Mode Toggle'),		category = _('Weapons Preparation')},
    ...
    {down = 3446, up = 3446, cockpit_device_id = devices.UVHF, value_down = 0, name = _('U/VHF Radio OFF'), category = _('Communications')},
    {down = 3446, up = 3446, cockpit_device_id = devices.UVHF, value_down = .25, name = _('U/VHF Radio ON'), category = _('Communications')},
    {down = 3448, up = 3448, cockpit_device_id = devices.UVHF, value_down = 1, name = _('U/VHF Guard Mode'), category = _('Communications')},
    {down = 3448, up = 3448, cockpit_device_id = devices.UVHF, value_down = 0, name = _('U/VHF Manual Mode'), category = _('Communications')},
    {down = 3448, up = 3448, cockpit_device_id = devices.UVHF, value_down = 0.5, name = _('U/VHF Preset Mode'), category = _('Communications')},
	...
	--RADALT
    {down = 3205, up = 3205, cockpit_device_id = devices.VTH_VTB, value_down = 0,   name = _('Radar Altimeter OFF'), category = _('Sensors')},
    {down = 3205, up = 3205, cockpit_device_id = devices.VTH_VTB, value_down = 0.5, name = _('Radar Altimeter ON'), category = _('Sensors')},
    {down = 3205, up = 3205, cockpit_device_id = devices.VTH_VTB, value_down = 1,   name = _('Radar Altimeter TEST'), category = _('Sensors')},
	...
	{down = 3204, up = 3204, cockpit_device_id = devices.VTH_VTB, value_down = 0, name = _('HUD Altimeter Power Switch OFF'), category = _('Electrical')},
	{down = 3204, up = 3204, cockpit_device_id = devices.VTH_VTB, value_down = 0.5, name = _('HUD Altimeter Power Switch ON'), category = _('Electrical')},
	{down = 3204, up = 3204, cockpit_device_id = devices.VTH_VTB, value_down = 1, name = _('HUD Altimeter Power Switch TEST'), category = _('Electrical')},
    ...
    {down = 3201, up = 3201, cockpit_device_id = devices.VTH_VTB, value_down = 0,  name = _('HUD OFF'), category = _('Cockpit Displays & Illumination')},
    {down = 3201, up = 3201, cockpit_device_id = devices.VTH_VTB, value_down = .5, name = _('HUD ON'), category = _('Cockpit Displays & Illumination')},
    {down = 3201, up = 3201, cockpit_device_id = devices.VTH_VTB, value_down = 1,  name = _('HUD TEST'), category = _('Cockpit Displays & Illumination')},
	{down = 3203, up = 3203, cockpit_device_id = devices.VTH_VTB, value_down = 0,  name = _('HUD Declutter Switch OFF'), category = _('Cockpit Displays & Illumination')},
	{down = 3203, up = 3203, cockpit_device_id = devices.VTH_VTB, value_down = 1,  name = _('HUD Declutter Switch ON'), category = _('Cockpit Displays & Illumination')},
    ...
    {down = 3221, up = 3221, cockpit_device_id = devices.VTH_VTB, value_down = 0, name = _('Radar Screen OFF'), category = _('Cockpit Displays & Illumination')},
    {down = 3221, up = 3221, cockpit_device_id = devices.VTH_VTB, value_down = 1, name = _('Radar Screen ON'), category = _('Cockpit Displays & Illumination')},
    ...
    {combos = {{key = 'Home',reformers = {'LAlt'}}},		down = iCommandViewNightVisionGogglesOn,											name = _('Helmet Visor/NVG TOGGLE'),		category = _('Pilot & Seat Controls')},
	{combos = {{key = 'Home',reformers = {'LAlt'}}},		down = iCommandPlaneDLK_Target1,													name = _('Switch between Visor and NVG'),	category = _('Pilot & Seat Controls')},
	...
	{combos = {{key = 'S', reformers = {'LShift','LAlt'}}},	pressed = iCommandPilotSeatAdjustmentDown,	up = iCommandPilotSeatAdjustmentStop,	name = _('Seat LOWER'),						category = _('Pilot & Seat Controls')},
		...
		-- NVG MOD
    {combos = {{key = 'H', reformers = {'RCtrl','RShift'}}}, pressed = iCommandPlane_Helmet_Brightess_Up , name = _('NVG Gain Up') , category = _('Pilot & Seat Controls')},
	{combos = {{key = 'H', reformers = {'RAlt','RShift'}}} , pressed = iCommandPlane_Helmet_Brightess_Down, name = _('NVG Gain Down'), category = _('Pilot & Seat Controls')},
