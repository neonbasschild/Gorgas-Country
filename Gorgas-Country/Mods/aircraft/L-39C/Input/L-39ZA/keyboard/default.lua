...
-- Stick
{combos = {{key = 'Space', reformers = {'LCtrl'}}},	down = 3022,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1.0,	name = _('Weapon Fire Button Safety'),	category = _('Stick')},
{combos = {{key = 'Space'}},						down = iCommandPlaneFire,	up = iCommandPlaneFireOff,	name = _('Weapon Fire Button'),	category = _('Stick')},
...
{combos = {{key = '8', reformers = {'RCtrl'}}},					pressed = device_commands.Button_2,	cockpit_device_id = devices.VD_20_INPUT,	value_pressed = -1,	name = _('Barometric Pressure QFE Knob - CCW'),	category = {_('Instrument Panel')}},
{combos = {{key = '8', reformers = {'RShift'}}},				pressed = device_commands.Button_2,	cockpit_device_id = devices.VD_20_INPUT,	value_pressed =  1,	name = _('Barometric Pressure QFE Knob - CW'),	category = {_('Instrument Panel')}},
-- KPP
...
{combos = {{key = 'L', reformers = {'LCtrl','LAlt'}}},		down = iCommandEngineLaunchMethod,	value_down = 0,																					name = _('Engine Launch Method Switch - STARTING'),			category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
{combos = {{key = 'L', reformers = {'LCtrl'}}},				down = iCommandEngineLaunchMethod,	value_down = -1,																				name = _('Engine Launch Method Switch - PRESERV'),			category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
{combos = {{key = 'L', reformers = {'LShift'}}},			down = iCommandEngineLaunchMethod,	value_down = 1,																					name = _('Engine Launch Method Switch - COLD ROTATION'),	category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
...
{combos = {{key = '6', reformers = {'RShift'}}},	down = electric_commands.L39C_Command_CB_HeatingSensorAOA_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Heating DUA-3 Switch - ON/OFF'),										category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '3', reformers = {'RCtrl'}}},		down = electric_commands.L39C_Command_CB_Weapon_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB WEAPON Switch - ON/OFF'),												category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '4', reformers = {'RCtrl'}}},		down = electric_commands.L39C_Command_CB_RTL_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RDO (ICS and Radio) Switch - ON/OFF'),									category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '5', reformers = {'RCtrl'}}},		down = electric_commands.L39C_Command_CB_WingTanks_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Tanks Switch - ON/OFF'),												category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
-- line 3
{combos = {{key = '1', reformers = {'RAlt'}}},		down = electric_commands.L39C_Command_CB_ISKRA_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RSBN (ISKRA) Switch - ON/OFF'),										category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '3', reformers = {'RAlt'}}},		down = electric_commands.L39C_Command_CB_EMERG_SRO_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB IFF (SRO) Emergency Connection Switch - ON/OFF'),						category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '5', reformers = {'RAlt'}}},		down = electric_commands.L39C_Command_CB_MRP_RV_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB MRP-RV (Marker Beacon Receiver and Radio Altimeter) Switch - ON/OFF'),	category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '6', reformers = {'RAlt'}}},		down = electric_commands.L39C_Command_CB_SDU_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB SDU Switch - ON/OFF'),													category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '1', reformers = {'LAlt'}}},				down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB Armament System Power Switch - ON/OFF'),						category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '1', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB Armament System Power Switch - OFF'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '1', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB Armament System Power Switch - ON'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '2', reformers = {'LAlt'}}},				down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - ON/OFF'),		category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '2', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - OFF'),		category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '2', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - ON'),			category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '3', reformers = {'LAlt'}}},				down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB Missile Firing Control Circuit Power Switch - ON/OFF'),		category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '3', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB Missile Firing Control Circuit Power Switch - OFF'),			category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '3', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB Missile Firing Control Circuit Power Switch - ON'),			category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '4', reformers = {'LAlt'}}},				down = device_commands.Button_61,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB Arm Bombs Power Switch - ON/OFF'),								category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '4', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_61,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB Arm Bombs Power Switch - OFF'),								category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '4', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_61,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB Arm Bombs Power Switch - ON'),									category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '5', reformers = {'LAlt'}}},				down = device_commands.Button_62,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB Arm Outer Guns Power Switch - ON/OFF'),						category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '5', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_62,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB Arm Outer Guns Power Switch - OFF'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '5', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_62,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB Arm Outer Guns Power Switch - ON'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '6', reformers = {'LAlt'}}},				down = device_commands.Button_63,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('CB Arm Inner Guns Power Switch - ON/OFF'),						category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '6', reformers = {'LAlt','LCtrl'}}},		down = device_commands.Button_63,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('CB Arm Inner Guns Power Switch - OFF'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '6', reformers = {'LAlt','LShift'}}},		down = device_commands.Button_63,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('CB Arm Inner Guns Power Switch - ON'),							category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit')}},
-- left side on the wall
{combos = {{key = '-', reformers = {'LShift'}}},				pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = -0.5,	name = _('Missile Seeker Tone Volume Knob - CCW'),													category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '=', reformers = {'LShift'}}},				pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = 0.5,	name = _('Missile Seeker Tone Volume Knob - CW'),													category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '8', reformers = {'LShift'}}},				down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Missile Seeker Heating Circuit Power Switch - ON/OFF'),									category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '8', reformers = {'LAlt','LCtrl'}}},			down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Missile Seeker Heating Circuit Power Switch - OFF'),										category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '8', reformers = {'LAlt','LShift'}}},			down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Missile Seeker Heating Circuit Power Switch - ON'),										category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '9', reformers = {'LShift'}}},				down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Missile Seeker Glowing Circuit Power Switch - ON/OFF'),									category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '9', reformers = {'LAlt','LCtrl'}}},			down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Missile Seeker Glowing Circuit Power Switch - OFF'),										category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '9', reformers = {'LAlt','LShift'}}},			down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Missile Seeker Glowing Circuit Power Switch - ON'),										category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '0', reformers = {'LShift'}}},				down = device_commands.Button_60,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Arm/Safe Cannon Gsh-23 Switch - ARM/SAFE'),												category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '0', reformers = {'LAlt','LCtrl'}}},			down = device_commands.Button_60,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Arm/Safe Cannon Gsh-23 Switch - SAFE'),													category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '0', reformers = {'LAlt','LShift'}}},			down = device_commands.Button_60,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Arm/Safe Cannon Gsh-23 Switch - ARM'),													category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
-- front left panel
{combos = {{key = 'R', reformers = {'RShift','RAlt','RCtrl'}}},	down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 2,			name = _('Missile/Bomb Release Selector Switch - PORT(Left)/STARB-BOTH(Right for Missiles/Both)'),	category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'R', reformers = {'RAlt','RCtrl'}}},			down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Missile/Bomb Release Selector Switch - STARB-BOTH(Right for Missiles/Both)'),				category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'R', reformers = {'RAlt','RShift'}}},			down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Missile/Bomb Release Selector Switch - PORT(Left)'),										category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'V', reformers = {'RShift'}}},				down = device_commands.Button_39,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0.1,		name = _('Rockets Firing Mode Selector Switch - AUT.'),												category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'V', reformers = {'RAlt'}}},					down = device_commands.Button_39,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0.2,		name = _('Rockets Firing Mode Selector Switch - 2RS'),												category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'V', reformers = {'RCtrl'}}},					down = device_commands.Button_39,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0.3,		name = _('Rockets Firing Mode Selector Switch - 4RS'),												category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'J', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_37,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Outboard Stations Switch Cover - OPEN/CLOSE'),							category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'K', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_38,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Outboard Stations Switch - ON/OFF'),									category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'L', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_64,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Inboard Stations Switch Cover - OPEN/CLOSE'),							category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = ';', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_65,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Inboard Stations Switch - ON/OFF'),									category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'U', reformers = {'LAlt'}}},					down = device_commands.Button_36,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Arm/Safe Bombs Emergency Jettison Switch - NEUTRAL'),										category = {_('Armament Control Panel'), _('Only Rear Cockpit')}},
{combos = {{key = 'U', reformers = {'LCtrl','LShift'}}},		down = device_commands.Button_40,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Arm/Safe Bombs Emergency Jettison Switch - LIVE/BLANK'),									category = {_('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'N', reformers = {'RCtrl','RShift'}}},		down = device_commands.Button_66,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Launch Missiles Button Cover - OPEN/CLOSE'),									category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'M', reformers = {'RCtrl','RShift'}}},		down = device_commands.Button_67, up = device_commands.Button_67, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1, value_up = 0,	name = _('Emergency Launch Missiles Button'),						category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'Q', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_68,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Gun+PK3 Switch Cover - OPEN/CLOSE'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'A', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_69,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Gun+PK3 Switch - ON/OFF'),																category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'W', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_70,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Charge Outer Guns Switch - ON/OFF'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'E', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_71,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Charge Inner Guns Switch - ON/OFF'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = 'S', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_72, up = device_commands.Button_72, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1, value_up = 0,	name = _('Pyro Charge Apply Button'),								category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'R', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_74,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Pyro Charge Selector Switch - Up'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'F', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_74,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Pyro Charge Selector Switch - Down'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
...
{combos = {{key = '5', reformers = {'LShift'}}},				down = device_commands.Button_48,									cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,					name = _('Outboard Stations Select Button'),					category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '6', reformers = {'LShift'}}},				down = device_commands.Button_50,									cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,					name = _('Inboard Stations Select Button'),						category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '5', reformers = {'LCtrl','LShift'}}},		down = device_commands.Button_49, up = device_commands.Button_49,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1, value_up = 0,	name = _('Outboard Stations Deselect Button'),					category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = '6', reformers = {'LCtrl','LShift'}}},		down = device_commands.Button_51, up = device_commands.Button_51,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1, value_up = 0,	name = _('Inboard Stations Deselect Button'),					category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'C', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_76,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Bomb Series Selector Switch - Up'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
{combos = {{key = 'X', reformers = {'LAlt','LCtrl','LShift'}}},	down = device_commands.Button_76,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Bomb Series Selector Switch - Down'),														category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit')}},
